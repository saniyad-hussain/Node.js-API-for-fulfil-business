...
module.exports.routes = {
  ...
  'GET /temporarystoragelocations': {swagger: {}},
  ...
  'DELETE /metadata': {
    swagger: {
      ...
      parameters: [
        ...
        {
          in: 'query',
          name: 'diameter_secondary',
          type: 'int',
          required: false
        },
        {
          in: 'query',
          name: 'diameter_narrow',
          type: 'int',
          required: false
        },
        {
      ...
      parameters: [
        {
          ...
          name: 'image',
          description:
            'send base 64 data which needs to store as image in bucket',
          required: true
        },
        {
          in: 'query',
  ...
  'POST /webhooksettings/saveWebHookSettings': {
    controller: 'webhooksettings',
    action: 'saveWebHookSettings',
    swagger: {
      tag: {name: ''},
      summary: '',
      description: 'Save All webhook settings in one call',
      parameters: [
        {
          in: 'body',
